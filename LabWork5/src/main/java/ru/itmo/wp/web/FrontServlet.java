...
public class FrontServlet extends HttpServlet {
    ...
    private Method getMethod(String methodInitialName, Class<?> pageClass) {
        Method method = null;
        for (Class<?> clazz = pageClass; method == null && clazz != null; clazz = clazz.getSuperclass()) {
            for (Method currentMethod : clazz.getDeclaredMethods()) {
                ...
                if (Objects.equals(methodName, methodInitialName)) {
    ...
    private void process(Route route,
        ...
        try {
            ...
            throw new ServletException("Can't get \'before\' or \'after\' methods from super class!");
        }
